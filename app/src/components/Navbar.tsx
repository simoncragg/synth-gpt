...
const Navbar = () => {
	...
	return (
		<>
			...
			<aside 
				className={`fixed top-0 left-0 z-40 w-64 h-screen p-0 pt-2 transition-transform border-r sm:translate-x-0 bg-gray-800 border-gray-700 ${isSidebarOpen ? "transform-none" : "-translate-x-full"}`} 
				aria-label="Sidebar" 
			>
				<div className="p-4">
