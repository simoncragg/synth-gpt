import { mapToContentParts, mapToSpokenTranscript } from "./contentMapper";
...
describe("contentMapper module", () => {
	...
	describe("mapToSpokenTranscript", () => {
		it("should map a paragraph to a spoken transcript", () => {
			const message = "This is a paragraph";
			const spokenTranscript = mapToSpokenTranscript(message);
			expect(spokenTranscript).toEqual("This is a paragraph\n");
		});

		it("should map an ordered list to a spoken transcript", () => {
			const message = "1. First item\n2. Second item";
			const spokenTranscript = mapToSpokenTranscript(message);
			expect(spokenTranscript).toEqual("1. First item\n2. Second item\n");
		});

		it("should not include code snippets in the spoken transcript", () => {
			const message =
		...
		it("should convert a message with paragraphs and ordered lists to spoken transcript and ignore code snippets", () => {
			const message =
				"Hello\n1. Item 1\n2. Item 2\n```typescript\nconsole.log('Hello World!');\n```\nBye";
			const result = mapToSpokenTranscript(message);
